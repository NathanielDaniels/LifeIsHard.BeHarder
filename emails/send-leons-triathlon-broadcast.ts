...
/**
 * Send the Leon's Triathlon invite to all active subscribers via Resend.
 *
 * Usage:
 *   RESEND_API_KEY=re_xxx RESEND_AUDIENCE_ID=xxx npx tsx emails/send-leons-triathlon-broadcast.ts
 *
 * Options:
...
async function main() {
  ...
  if (isDryRun) {
    ...
    console.log(`Subject: ${leonsTriathlonInviteSubject}`);
