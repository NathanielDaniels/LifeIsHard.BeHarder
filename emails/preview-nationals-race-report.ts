...
import NationalsRaceReportEmail from "./nationals-race-report-email";
...
const previewImagePaths = [
  ...
  "email/nationals-recap/nr-pre-race.jpg",
  "email/nationals-recap/nr-swim.jpg",
  "email/nationals-recap/nr-water-exit.jpg",
  "email/nationals-recap/nr-bike.jpg",
];
...
async function main() {
  ...
  const outPath = resolve(__dirname, "nationals-race-report-preview.html");
