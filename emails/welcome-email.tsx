...
export default function WelcomeEmail({ email }: WelcomeEmailProps) {
  ...
  return (
    <Html lang="en" dir="ltr">
      ...
      <Preview>You're on the list. Something unstoppable is coming — patrickwingert.com</Preview>
      ...
      <Body style={body}>
        <Container style={wrapper}>
          ...
          <Section style={headerZone}>
            ...
            <Text style={systemTag}>{'>'} SIGNAL LOCKED — SUBSCRIBER VERIFIED</Text>
            ...
            <Text style={subtitleSmall}>DARE2TRI ELITE TEAM ATHLETE • ADAPTIVE TRIATHLETE</Text>
          </Section>

          {/* ========== BODY CONTENT ========== */}
          <Section style={contentSection}>
            <Text style={bodyText}>
              You just locked in your spot.
            </Text>
            <Text style={bodyText}>
              An immersive digital experience is being built, documenting every mile, 
              every heartbeat, every moment of a journey that was never supposed to happen. 
              Live biometrics. Real data. No filter.
            </Text>
          ...
          <Section style={statsCard}>
            ...
            <Row style={{ width: '100%' }}>
              <Column style={statCell}>
                <Text style={statNumber}>{daysSinceAccident.toLocaleString()}</Text>
          ...
          <Section style={teaserSection}>
            ...
            <Row style={{ width: '100%', marginBottom: '12px' }}>
              ...
              <Column style={teaserTextCol}>
                <Text style={teaserText}>Live heart rate & biometrics powered by WHOOP</Text>
              </Column>
            </Row>
            <Row style={{ width: '100%', marginBottom: '12px' }}>
              <Column style={teaserBulletCol}>
              ...
              <Column style={teaserTextCol}>
                <Text style={teaserText}>The full story from accident to elite athlete</Text>
              </Column>
            </Row>
            <Row style={{ width: '100%', marginBottom: '12px' }}>
              <Column style={teaserBulletCol}>
              ...
              <Column style={teaserTextCol}>
                <Text style={teaserText}>250-mile Trans Bhutan Trail documentary content</Text>
              </Column>
            </Row>
            <Row style={{ width: '100%', marginBottom: '0' }}>
              ...
              <Column style={teaserTextCol}>
                <Text style={teaserText}>2026 race calendar & sponsorship opportunities</Text>
              </Column>
            </Row>
          </Section>
          ...
          <Section style={footerSection}>
            ...
            <Text style={footerMuted}>
              You're receiving this because {email || 'you'} signed up at patrickwingert.com.
            </Text>
            <Text style={footerMuted}>
              One inspires many.
            </Text>
